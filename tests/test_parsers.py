...
class TestApacheParser:
    ...
    def test_parse_apache_combined_captures_referer_and_user_agent(self):
        parser = ApacheParser()
        line = (
        ...
        assert entry.metadata["referer"] == "http://www.example.com/start.html"
        assert entry.metadata["user_agent"] == "Mozilla/4.08"
